        ...
        <div class="row">
          <div class="col-12 col-sm-9">
            ...
            <form action="{{route('admin.course.question.update',$acknowledge->id)}}" method="post">
              @method('put')
              @csrf
                <input class="form-control" type="hidden" name="course_id" value="{{$acknowledge->course_id}}" required="">
              ...
              <div class="mb-3 wow animate__animated animate__fadeInUp">
                ...
                <input type="text" class="form-control" placeholder="Title" name="title" value="{{$acknowledge->title}}" id="course-title">
              ...
              <div class="mb-3 wow animate__animated animate__fadeInUp">
                ...
                <input type="text" class="form-control"  placeholder="Arabic Title" name="ar_title" value="{{$acknowledge->ar_title}}" id="course-title">
              ...
              <div class="mb-3 wow animate__animated animate__fadeInUp">
                ...
                <input type="text" class="form-control" placeholder="Urdu Title" name="ur_title" value="{{$acknowledge->ur_title}}" id="course-title">
                    ...
                    <div class="radio">
                      ...
                      @endif
                       ...
                       <input name="option_id[]" value="{{$option->id}}" type="hidden">
                        <input id="radio-{{$key+1}}" name="correct_answers[]" @if($option->correct == 1) checked  @endif value="{{$key+1}}" type="radio">
                        <label for="radio-{{$key+1}}" class="radio-label">
                        <div class="inner__label">
                            <input type="text" required="required" class="form-control border-0 w-100" value="{{$option->answar}}" placeholder="Answer '{{$key+1}}'" name="options[]" id="">
                            </div>
                            </label>
                            <div class="others__inputs my-3">
                                <input type="text" required="required" class="form-control mb-2" value="{{$option->ar_answar}}" placeholder="Arabic Answer '{{$key+1}}'" name="ar_options[]" id="">
                                <input type="text" required="required" class="form-control" value="{{$option->ur_answar}}" placeholder="Urdu Answer '{{$key+1}}'" name="ur_options[]" id="">
                                </div>
                                </div>
                                </div>                                
                      @endforeach
