          ...
          <div class="col-12 col-sm-9">
            ...
            <div class="dropcoursehere wow animate__animated animate__fadeInUp">
              <div class="inner__dropfilebox">
                ...
                <input type='file' class="h-full w-full opacity-0" name="thumbnail" onchange="readURL(this);" />
            ...
            <div class="course__about wow animate__animated animate__fadeInUp">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="title" value="{{$lesson->title}}" class="form-control" id="course-title">
                @error('title')
                <span class="error_alert">{{$message}}</span>
                @enderror
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" name="ar_title" value="{{$lesson->ar_title}}" class="form-control" id="course-title">
                @error('ar_title')
                <span class="error_alert">{{$message}}</span>
                @enderror
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" name="ur_title" value="{{$lesson->ur_title}}" class="form-control" id="course-title">
                @error('ur_title')
                <span class="error_alert">{{$message}}</span>
                @enderror
              </div>
              ...
              <div class="mb-3">
                ...
                <select type="text" class="form-select" onchange="fileType(this.value)" name="type" >
                  <option value="" selected>Select Type</option>
                    <option @if($lesson->type == "other-img") selected @else @endif value="other-img" >Image</option>
                    <option @if($lesson->type == "other-pdf") selected @else @endif value="other-pdf">Pdf</option>
                </select>
              ...
              <div class="my-5 video__droper" @if($lesson->type == "other-img") @else style="display: none;" @endif id="imageFile">
                <h3 class="my-4">Images</h3>
                <div class="row">
                  <div class="col-12 col-sm-4">
                    <div class="dropcoursehere">
                      <div class="inner__dropfilebox">
                        <img id="ImageShowOne" src="{{asset($lesson['images'][0]['image'] ?? 'assets/images/image_upload.png')}}" />
                        <input type="hidden" name="image_id[]" value="{{$lesson['images'][0]['id']}}">
                        <div class="drop__here">
                          <div class="edit__button">
                            <button type="button" class="btn btn-primary"><i class="fa fa-pencil-alt"
                                aria-hidden="true"></i>
                  ...
                  <div class="col-12 col-sm-4">
                    <div class="dropcoursehere">
                      <div class="inner__dropfilebox">
                        <img id="ImageShowTwo" src="{{asset($lesson['images'][1]['image'] ?? 'assets/images/image_upload.png')}}" />
                        <input type="hidden" name="image_id[]" value="{{$lesson['images'][1]['id']}}">
                        <div class="drop__here">
                          <div class="edit__button">
                            <button type="button" class="btn btn-primary"><i class="fa fa-pencil-alt"
                                aria-hidden="true"></i>
                  ...
                  <div class="col-12 col-sm-4">
                    <div class="dropcoursehere">
                      <div class="inner__dropfilebox">
                        <img id="ImageShowThree" src="{{asset($lesson['images'][2]['image'] ?? 'assets/images/image_upload.png')}}" />
                        <input type="hidden" name="image_id[]" value="{{$lesson['images'][2]['id']}}">
                        <div class="drop__here">
                          <div class="edit__button">
                            <button type="button" class="btn btn-primary"><i class="fa fa-pencil-alt"
                                aria-hidden="true"></i>
              ...
              <div class="" @if($lesson->type == "other-pdf") @else style="display: none;" @endif id="pdfFile">
