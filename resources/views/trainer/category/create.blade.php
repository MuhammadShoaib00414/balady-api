        ...
        <div class="col-12 col-sm-9">
          ...
          <div class="dropcoursehere wow animate__animated animate__fadeInUp">
            <div class="inner__dropfilebox">
              ...
              <input type='file' required="required" name="category_thumbnail" class="h-full w-full opacity-0" onchange="readURL(this);" />
            </div>
          </div>
          <!-- banner -->
          ...
          <div class="course__header wow animate__animated animate__fadeInUp">
            <p class="course__title flex-fill">Add Category</p>
          </div>
          <!-- course header -->
          <!-- course about -->
          ...
          <div class="course__about wow animate__animated animate__fadeInUp">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="Category Title" id="course-title">
              @error('name')
          ...
          <div class="course__about wow animate__animated animate__fadeInUp">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="ar_name" value="{{old('ar_name')}}" placeholder="Category Arabic Title" id="course-title">
              @error('ar_name')
              <span class="error_alert">{{$message}}</span>
              @enderror
            </div>
          ...
          <div class="course__about wow animate__animated animate__fadeInUp">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="ur_name" value="{{old('ur_name')}}"  placeholder="Category Urdu Title" id="course-title">
              @error('ur_name')
              <span class="error_alert">{{$message}}</span>
              @enderror
            </div>
