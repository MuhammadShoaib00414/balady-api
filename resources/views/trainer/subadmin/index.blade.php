...
<div class="col-10 offset-2" id="main__content">
    ...
    <div class="course__template">
      <div class="course__search__field justify-content-between align-items-center mb-5 wow animate__animated animate__fadeInUp">
        <p class="course__title">Sub Admin</p>
        <div class="course__search__field mb-5">
            <div class="search__field">
                <div class="input-group"> </div>
            </div>
            <a type="button" href="{{route('admin.subadmin.create')}}" class="btn add__course w-100"><i class="fa fa-plus" aria-hidden="true"></i>Add Sub Admin</a> </div>
    </div>
                ...
                <td>
                    <div class="btn-group dropstart option__dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{route('admin.subadmin.show',$subadmin->id)}}" class="dropdown-item" type="button">view</a></li>
                            <li><a  href="{{route('admin.subadmin.edit',$subadmin->id)}}" class="dropdown-item" type="button">Edit</a></li>
                            <li><a  href="{{route('admin.subadmin.destroy',$subadmin->id)}}" class="dropdown-item data-delete" type="button">Delete</a></li>
                        </ul>
                    </div>
                </td>
            </tr>
