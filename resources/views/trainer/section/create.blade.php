        ...
        <div class="row">
          <div class="col-12 col-sm-9">
            ...
            <div class="course__header wow animate__animated animate__fadeInUp">
              <p class="course__title flex-fill">Add Section</p>
            </div>
            <!-- course header -->
            <!-- course about -->
            ...
            <div class="course__about wow animate__animated animate__fadeInUp">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" value="{{old('name')}}" id="course-title">
                @error('name')
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="ar_name" value="{{old('ar_name')}}" id="course-title">
                @error('ar_name')
                <span class="error_alert">{{$message}}</span>
                @enderror
              </div>
            ...
            <div class="course__lesson d-flex justify-content-end wow animate__animated animate__fadeInUp">
              <div class="add__course__lesson">
                <button type="submit" class="btn add__course me-2">Add Section</button>
              </div>
