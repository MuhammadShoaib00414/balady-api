...
@section('content')
        ...
        <div class="col-12 col-sm-9">
          ...
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb wow animate__animated animate__fadeInUp">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('admin.Exam') }}</li>
            </ol>
        </nav>
          <!-- breadcrumbs -->
            <!-- courses section -->
    ...
    <div class="course__template">
      <div class="course__search__field mb-5 wow animate__animated animate__fadeInUp">
        <div class="search__field">
          <div class="input-group">
            <div class="form-outline">
              <input id="search-input" type="search" id="form1" placeholder="{{ __('admin.Search') }}" class="form-control" />
            </div>
        ...
        <a type="button" href="{{route('admin.exam.create',['type' => 'mumtathil'])}}" class="btn add__course"><i class="fa fa-plus" aria-hidden="true"></i>{{ __('admin.Add Question') }}</a>
      </div>
      <!-- courses section -->
      <!-- courses cards -->
    <!-- courses cards -->
