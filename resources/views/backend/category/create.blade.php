      ...
      <div class="row">
        <div class="col-12 col-sm-9">
          ...
          <div class="course__header wow animate__animated animate__fadeInUp">
            <p class="course__title flex-fill">{{ __('admin.Category Add Form') }}</p>
          </div>
          <!-- course header -->
          <!-- course about -->
          ...
          <div class="course__about wow animate__animated animate__fadeInUp">
            <div class="mb-3">
              ...
              <input type="text" class="form-control ltr" name="name" value="{{old('name')}}" id="course-title">
              @error('name')
          ...
          <div class="course__about wow animate__animated animate__fadeInUp">
            <div class="mb-3">
              ...
              <input type="text" class="form-control rtl" name="ar_name" value="{{old('ar_name')}}" id="course-title">
              @error('ar_name')
              <span class="error_alert">{{$message}}</span>
              @enderror
            </div>
          ...
          <div class="course__about wow animate__animated animate__fadeInUp">
            <div class="mb-3">
              ...
              <input type="text" class="form-control rtl" name="ur_name" value="{{old('ur_name')}}"  id="course-title">
              @error('ur_name')
              <span class="error_alert">{{$message}}</span>
              @enderror
            </div>
