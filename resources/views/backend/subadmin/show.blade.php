    ...
    <div class="course__search__field justify-content-between align-items-center mb-5">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb wow animate__ animate__fadeInUp animated"
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('admin.Show Sub Admin') }}</li>
            </ol>
        </nav>
    </div>
        <!-- courses section -->
          ...
          <div class="row">
            <div class="col-12 col-sm-6">
              <div class="user__info__cards wow animate__animated animate__fadeInUp">
                ...
                <p>{{ __('admin.Sub Admin Information') }}</p>
                <div class="user__profile__det">
                  <img src="{{asset($subadmin->image)}}" class="img-fluid" alt="">
                ...
                <div class="row">
                  <div class="col-12 col-sm-7">
                    <div class="activity__info">
                      ...
                      <p class="activity__desp">{{$subadmin->email}}</p>
                    </div>
                    <div class="activity__info">
                      <p class="activity__heading">{{ __('admin.Phone Number') }}</p>
                      <p class="activity__desp">{{$subadmin->phone}}</p>
                    </div>
                  ...
                  <div class="col-12 col-sm-5">
                    <div class="activity__info">
                      ...
                      <p class="activity__desp">{{$subadmin->roles[0]->name}}</p>
                    </div>
                  </div>
                </div>
                <br>
