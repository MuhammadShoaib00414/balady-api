        ...
        <div class="course__search__field justify-content-between align-items-center mb-5">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb wow animate__ animate__fadeInUp animated"
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('admin.Add Sub Admin') }}</li>
                </ol>
            </nav>
        </div>
        <!-- courses section -->
        <!-- activity details -->
        <div class="profile__info__details wow animate__ animate__fadeInUp animated"
            style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="col-12 col-sm-7">
                            <div class="profile__fields">
                                ...
                                <div class="mb-3">
                                    <div class="dropcoursehere">
                                        <div class="inner__dropfilebox">
                                            <img id="blah" style="border-radius: 50%; width:50%;"
                                            ...
                                            <input type='file' class="h-full w-full opacity-0" required="required"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control ltr" id="your-name" name="first_name"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control ltr" id="your-name" name="last_name"
                                        value="{{ old('last_name') }}">
                                </div>
                                @error('last_name')
                                    <span class="error_alert">{{ $message }}</span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control ltr" id="your-email" name="email"
                                        value="{{ old('email') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control ltr" id="your-phonenumber" name="phone"
                                        value="{{ old('phone') }}">
                                </div>
                        ...
                        <div class="col-12 col-sm-5" style="margin-top: 64px;">
                            <div class="profile__fields">
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control ltr" name="password" id="new-pass">
                                </div>
