        ...
        <div class="course__search__field justify-content-between align-items-center mb-5">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb wow animate__ animate__fadeInUp animated"
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('admin.Edit Trainer') }}</li>
                </ol>
            </nav>
        </div>
        <!-- courses section -->
                ...
                <div class="col-12 col-sm-7">
                  <div class="profile__fields">
                    ...
                    <div class="mb-3">
                        <div class="dropcoursehere" >
                          <div class="inner__dropfilebox">
                            <img id="blah" style="border-radius: 50%; width:50%;" src="{{asset($trainer->image)}}" />
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="your-name" name="first_name" value="{{$trainer->first_name}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="your-name" name="last_name" value="{{$trainer->last_name}}">
                    </div>
                    @error('last_name')
                    <span class="error_alert">{{$message}}</span>
                    @enderror
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" class="form-control" id="your-email" name="email" value="{{$trainer->email}}">
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="your-phonenumber" name="phone" value="{{$trainer->phone}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="biography" name="biography">{{$trainer->biography}}</textarea>
                        @error('biography')
                        <span class="error_alert">{{$message}}</span>
                        @enderror
                      </div>
