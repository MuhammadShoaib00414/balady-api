...
@section('content')
    ...
    <div class="course__template">
      <div class="course__search__field justify-content-between align-items-center mb-5 wow animate__animated animate__fadeInUp">
        <p class="course__title">{{ __('admin.Trainer') }}</p>
        <div class="course__search__field mb-5">
            <div class="search__field">
                <div class="input-group"> </div>
            </div>
            <a type="button" href="{{route('admin.trainer.create')}}" class="btn add__course w-100"><i class="fa fa-plus" aria-hidden="true"></i>{{ __('admin.Add Trainer') }}</a> </div>
    </div>
                ...
                <td>
                    <div class="btn-group dropstart option__dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{route('admin.trainer.show',$trainer->id)}}" class="dropdown-item" type="button">               {{ __('admin.View') }}</a></li>
                            <li><a  href="{{route('admin.trainer.edit',$trainer->id)}}" class="dropdown-item" type="button">              {{ __('admin.Edit') }}</a></li>
                            <li><a  href="{{route('admin.trainer.delete',$trainer->id)}}" class="dropdown-item data-delete" type="button">{{ __('admin.Delete') }}</a></li>
                        </ul>
                    </div>
                </td>
            </tr>
